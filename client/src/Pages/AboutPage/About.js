        ...
        if (typeof window.ethereum !== "undefined") {
            ...
            try {
                ...
                web.eth.getAccounts().then(async (account) => {
                    let contract = await new web.eth.Contract(KiFTabi, "0x2F5b9e3c11aFB60A582777dde9D1D4F5B921Fe7a");
                    await contract.methods
                        .isApprovedForAll(sellitem.contract_address, "0x2F5b9e3c11aFB60A582777dde9D1D4F5B921Fe7a")
                        .call({
                            from: account[0],
                        })
                        .then(async (result) => {
