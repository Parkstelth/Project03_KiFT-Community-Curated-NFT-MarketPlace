...
function About({ loginAccount, isKaikas /* 로그인된 계정 */ }) {
  ...
  async function loadSellItem() {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/searchNFT",
        {
          openseaId: URLparam,
        },
        headers
  ...
  async function loadSellItemOnKlay() {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/klaytn/searchNFT",
        {
          openseaId: URLparam,
        },
        headers
  ...
  async function listNFTOnTheMarket(result) {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/listItemOnlist",
        {
          openseaId: URLparam,
      ...
      .then(async (result) => {
        if (result.status === 200) {
          ...
          await axios
            .post("http://3.37.89.170:3001/toGiveContributePoint", {
  ...
  async function ChangePriceNFTOnTheMarket(priceSellerPut, result) {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/listItemOnchange",
        {
          openseaId: URLparam,
          price: priceSellerPut,
          from: result.from,
  ...
  async function CancleNFTOnTheMarket(result) {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/listItemOncancel",
        {
          openseaId: URLparam,
          isSale: false,
          price: 0,
  ...
  async function soldoutNFTOnTheMarket(to, from, itemprice) {
    ...
    await axios
      .post(
        "http://3.37.89.170:3001/listItemOnbuy",
        {
          openseaId: URLparam,
          price: 0,
          isSale: false,
